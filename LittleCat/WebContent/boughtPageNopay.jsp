...
<div class="boughtDiv">
	<div class="orderType">
		<div ><a orderStatus="all" href="shopcar/findAllOrders#all">所有订单</a></div>
		<div class="selectedOrderType"><a  orderStatus="waitPay" href="shopcar/findNoPay#nopay">待付款</a></div>
